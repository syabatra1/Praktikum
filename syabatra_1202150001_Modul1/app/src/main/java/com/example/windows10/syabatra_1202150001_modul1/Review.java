package com.example.windows10.syabatra_1202150001_modul1;
...
public class Review extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast toast = null;
        if(price < 65000) {
            toast = Toast.makeText(getApplicationContext(), "MAKAN SENE BOSS", Toast.LENGTH_SHORT);
        }else{
            toast = Toast.makeText(getApplicationContext(), "BOROSS SENE BOSS", Toast.LENGTH_SHORT);
        }
        toast.show();
    }
}
